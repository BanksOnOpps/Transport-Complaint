...
function CheckFeedback() {
  ...
  return (
    <Grid $columns="repeat(4, 1fr)">
      <Card>
        <Count $bg="var(--color-card-1)">{totalComplaint}</Count>
        <Label>All</Label>
      </Card>

      <Card>
        <Count $bg="var(--color-card-2)">{pendingComplaint}</Count>
        <Label>Pending</Label>
      </Card>

      <Card>
        <Count $bg="var(--color-card-3)">{resolvedComplaint}</Count>
        <Label>Resolved</Label>
      </Card>

      <Card>
        <Count $bg="var(--color-card-4)">{rejectedComplaint}</Count>
